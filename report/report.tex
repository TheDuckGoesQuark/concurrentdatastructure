...
The erraneous lockfree implementation of deposit using the \url{atomic_compare_exchange_weak} function was as follows:
\begin{lstlisting}
...
Out of curiosity, the same method was written to use the deprecated \url{__sync_bool_compare_and_swap} builtin.
